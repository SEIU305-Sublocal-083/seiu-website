...
This is item 1 of 6 in the Website and news stack. Its base is `codex/strike-translation-review` (PR #253); its diff adds only this item's directory. Edit this item on its own branch and carry parent updates forward. See [stack workflow](../STACK.md). Keep this PR draft during translation review.
