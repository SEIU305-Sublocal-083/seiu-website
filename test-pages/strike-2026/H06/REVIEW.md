...
This is item 6 of 8 in the Guides and Q&A stack. Its base is `codex/strike-h05-health-coverage-planned-leave-vacation-and-surgery` (PR #267); its diff adds only this item's directory. Edit this item on its own branch and carry parent updates forward. See [stack workflow](../STACK.md). Keep this PR draft during translation review.
