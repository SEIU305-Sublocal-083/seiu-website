...
This is item 6 of 8 in the Emails stack. Its base is `codex/strike-e05-wednesday-certified-result-or-pending-email-variants` (PR #259); its diff adds only this item's directory. Edit this item on its own branch and carry parent updates forward. See [stack workflow](../STACK.md). Keep this PR draft during translation review.
